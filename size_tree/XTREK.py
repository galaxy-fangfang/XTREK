...
def get_best_split(y, X, low_bound, total_size):
    """
...
class SizeBasedRegressionTree(object):
    ...
    """
    def __init__(self, max_depth=None, max_nodes=128):
    ...
    def build(self, low_bound_layer):
        """
        Function which recursively builds the tree using incremental weighted kendall
        ...
        while(self.queue1):
            ...
            best_feature, best_value = get_best_split(y, X, low_bound, self.total_size)
